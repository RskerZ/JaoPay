...
public class Fuckla extends AppCompatActivity {
        Button purchase_btn;
        Button return_btn;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_fuckla);
        ...
        private View.OnClickListener purchase = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                controller.setIteminfo("i:ferrari",20000000);
                controller.show_purchase_page_GUI(Fuckla.this);
            }
        };
