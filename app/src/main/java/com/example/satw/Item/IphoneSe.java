...
public class IphoneSe extends AppCompatActivity {
    Button purchase_btn;
    Button return_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iphone_se);
    ...
    private View.OnClickListener purchase = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            controller.setIteminfo("i:iphonese",14000);
            controller.show_purchase_page_GUI(IphoneSe.this);
        }
    };
